...
public class Level_25_Data_In_XML extends BaseTest {
	...
	@Parameters({ "email", "firstName", "lastName", "password", "browser" })
	@BeforeClass
	public void beforeClass(String emailAddress ,String firstName, String lastName, String password, String browserName ) {
		this.browserName = browserName;
		this.firstName = firstName;
		this.lastName = lastName;
		this.emailAddress = getEmailAddress(emailAddress);
