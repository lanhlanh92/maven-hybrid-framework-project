...
public class PersonalDetailsPageUI {	
	...
	public static final String NATIONALITY_DROPDOWN_CHILD = "Xpath=//label[text()='Nationality']/parent::div/following-sibling::div//div[@class='oxd-select-option']";
	public static final String NATIONALITY_DROPDOWN_SELECTED_TEXT = "Xpath=//div[@class='oxd-select-text-input']";
	...
	public static final String MARITAL_STATUS_DROPDOWN_CHILD = "Xpath=//label[text()='Marital Status']/parent::div/following-sibling::div//div[@class='oxd-select-option']";
	public static final String MARITAL_STATUS_DROPDOWN_SELECTED_TEXT = "Xpath=//div[@class='oxd-select-text-input']";
