...
import testdata.staticVariable.UserObjects;
...
public class Level_26_Data_In_Internal extends BaseTest {
	...
	public void beforeClass(String browserName ) {
		...
		firstName = UserObjects.FIRST_NAME;
		lastName = UserObjects.LAST_NAME;
		emailAddress =  getEmailAddress(UserObjects.EMAIL_ADDRESS);
